...
<body class="body-panel">
    ...
    <div style="display: flex; height: 70vh; flex-wrap: wrap; align-items: center; justify-content: center; align-content: flex-start;">
        ...
        <form method="post" class="form" style="background-color:rgba(0,0,0,0.5); backdrop-filter: blur(5px);-webkit-backdrop-filter: blur(5px);width: 80%;        max-width: 380px;" onsubmit="active_loader()">
            ...
            <label for="tel_input" id="tel_input_label" style="color:white;display: none">Num̩ro de T̩l̩phone
                <input type="tel" id="tel_input" name="TelUtilisateur" style="width:100%" placeholder="Num̩ro de T̩l̩phone" autocomplete="current-tel">
            </label>
            ...
            <a href="recover.php" class="more_txt " onclick="active_loader(); ">Mot de passe oubli̩ ? </a>
            <?php if ($redirect_join) { // si l'url contient le token d'̩quipe
