...
if($are_all_set && $are_not_empty){
    ...
    if(isset($result[0]) and $result[0]['NombreUtilisateurs'] == 0){
        ...
        $query = $conn2->prepare("INSERT INTO players (PlayerId, PlayerLastname, PlayerFirstname, PlayerEmail, PlayerTel, PlayerPassword, PlayerCreation_date, PlayerDiscord, PlayerProfil,PlayerUsername) 
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?,?)");
